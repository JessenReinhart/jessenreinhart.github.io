        ...
        <div className="relative w-full select-none">
          <div className="w-full flex justify-center">
            <BlurText
              ...
              direction="top"
              as="h1"
              className="font-display font-bold text-[clamp(7rem,13vw,10rem)] leading-[0.72] tracking-tighter uppercase justify-center whitespace-nowrap"
          ...
          <div className="absolute top-[55%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none">
            <div
              className="w-[70px] h-[105px] md:w-[80px] md:h-[120px] lg:w-[95px] lg:h-[140px] rounded-full overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-110 pointer-events-auto"
